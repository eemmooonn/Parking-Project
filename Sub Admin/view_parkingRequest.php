...
>>>>>>> 697d6cf5095a54f3ae01c87aaab6e07c3e9258d9
  ...
  $sqlDelete="DELETE FROM `booking_request` WHERE `booking_id` =$booking_id ";
  $delete = mysqli_query($con, $sqlDelete);
}
if(isset($_POST['remove']))
{
  $booking_id = $_POST["booking_id"];
  $sqlInsert="INSERT INTO `removed_bookingrequest` SELECT * FROM `booking_request` WHERE booking_id=$booking_id";
  $insert = mysqli_query($con, $sqlInsert);
  $sqlDelete="DELETE FROM `booking_request` WHERE `booking_id` =$booking_id ";
  $delete = mysqli_query($con, $sqlDelete);
}
                ...
                <table class="styled-table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $bookingRequest = "SELECT * FROM `booking_request` WHERE place_id='$id'";
